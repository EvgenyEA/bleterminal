...
//const led1Button = document.getElementById('led1-form');
//led1Button.checked = false;
//
//const led2Button = document.getElementById('led2-form');
//led2Button.checked = false;
...
//// Turn on led1 by pressing button
//led1Button.addEventListener('submit', async (event) => {
//  event.preventDefault();
//
//  try {
//    // Send a message to the connected device.
//    value = 0;
//    if (!led1Button.checked) {
//       await bluetoothTerminal.send(1);
//       logToTerminal("Led 1 on", 'outgoing');
//       led1Button.checked = true;
//    }
//    else {
//       await bluetoothTerminal.send(2);
//       logToTerminal("Led 1 off", 'outgoing');
//       led1Button.checked = false;
//    }
//   
//  } catch (error) {
...
//    if(slider.value == 0) {
//        logToTerminal('set 0', 'outgoing');
//    }
//    else if(slider.value == 1) {
//        logToTerminal('set 1', 'outgoing');
//    else if(slider.value == 2) {
//        logToTerminal('set 2', 'outgoing');
//    }
//    else if(slider.value == 3) {
//        logToTerminal('set 3', 'outgoing');
//    }
//    else if(slider.value == 4) {
//        logToTerminal('set 4', 'outgoing');
//    }
    logToTerminal(slider.value, 'outgoing');
    try {
        
        bluetoothTerminal.send(slider.value) 
    } 
    catch (error) {
        logToTerminal(error, 'error');
    }
